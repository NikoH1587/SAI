...
switch (SAI_CFG_WEST_COM) do {
	...
	case 4: {SAI_SPAWN_WEST = [SAI_SPAWN_WEST_HEL, SAI_SPAWN_WEST_HEL, SAI_SPAWN_WEST_HEL, SAI_SPAWN_WEST_PLA]};
...
switch (SAI_CFG_EAST_COM) do {
	...
	case 4: {SAI_SPAWN_EAST = [SAI_SPAWN_EAST_HEL, SAI_SPAWN_EAST_HEL, SAI_SPAWN_EAST_HEL, SAI_SPAWN_EAST_PLA]};
