...
SAI_SPAWN_WEST = [SAI_SPAWN_WEST_MOT, SAI_SPAWN_WEST_MOT, SAI_SPAWN_WEST_MEC, SAI_SPAWN_WEST_MEC, SAI_SPAWN_WEST_STA, SAI_SPAWN_WEST_ARM, SAI_SPAWN_WEST_HEL, SAI_SPAWN_WEST_PLA];
...
SAI_SPAWN_EAST = [SAI_SPAWN_EAST_MOT, SAI_SPAWN_EAST_MOT, SAI_SPAWN_EAST_MEC, SAI_SPAWN_EAST_MEC, SAI_SPAWN_EAST_STA, SAI_SPAWN_EAST_ARM, SAI_SPAWN_EAST_HEL, SAI_SPAWN_EAST_PLA];
