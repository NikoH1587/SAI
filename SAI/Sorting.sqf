...

{
	...
	switch (_type) do {
		case "INF_WEST": {SAI_WEST_INF append [_x]; SAI_WEST_ALL append [_x]};
		case "VEH_WEST": {SAI_WEST_VEH append [_x]; SAI_WEST_ALL append [_x]};
		case "ARM_WEST": {SAI_WEST_ARM append [_x]; SAI_WEST_ALL append [_x]};
		...
		case "INF_EAST": {SAI_EAST_INF append [_x]; SAI_EAST_ALL append [_x]};
		case "VEH_EAST": {SAI_EAST_VEH append [_x]; SAI_EAST_ALL append [_x]};
		case "ARM_EAST": {SAI_EAST_ARM append [_x]; SAI_EAST_ALL append [_x]};
