...

{
	...
	if (_typ == "HEL") then {
		if (_pos distance SAI_POS_WEST > SAI_DISTANCE) then {SAI_OPS_WEST append [[_grp, "MOV", SAI_POS_WEST]]} else {
			SAI_OPS_WEST append [[_grp, "LOG", SAI_POS_WEST]];		
		};
	};
...

{
	...
	if (_typ == "HEL") then {
		if (_pos distance SAI_POS_EAST > SAI_DISTANCE) then {SAI_OPS_EAST append [[_grp, "MOV", SAI_POS_EAST]]} else {
